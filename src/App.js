...
const Home = lazy(() => import('./pages/Impormas/HomeIndex'));
const Factura = lazy(() => import('./pages/Impormas/FacturaIndex'));
const Recibo = lazy(() => import('./pages/Impormas/ReciboIndex'));
const Pedido = lazy(() => import('./pages/Impormas/PedidoIndex'));
          ...
          <ScrollToTop>
            ...
            >
              <Switch>
                ...
                <PrivateRoute
                  path={process.env.PUBLIC_URL + "/facturas"}
                  component={Factura}
                />
                ...
                />
                <Route
                  path={process.env.PUBLIC_URL + "/shop-grid-filter/:categoriaid"}
